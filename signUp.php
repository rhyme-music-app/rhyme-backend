                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <div class="form-outline form-white mb-4">
                                    <input type="email" placeholder="username" id="typeUserName"
                                ...
                                <div class="form-outline form-white mb-4">
                                    <input type="password" placeholder="confirm password" id="typePasswordX"
                                        class="form-control form-control-lg" />
                                </div>
                            ...
                            <div>
                                <p class="mb-0">Alrealy have an account? <a href="signIn.php"
